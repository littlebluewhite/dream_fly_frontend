/* Dream Fly — 教練端 Coach Portal · data + helpers
   Rebuilt to match the SEC/CoachPortal design in the .pen source.
   Persona: 李志偉 教練 (Wilson Li) · 資深體操教練 · gold avatar. Date: 2026年5月30日 星期六 */
...
const TODAY_LABEL = "2026年5月30日 星期六";

/* ---- Today's classes (5 堂) ---- */
/* status: done 已結束 / live 上課中 / soon 即將開始 / wait 尚未開始 */
const TODAY_CLASSES = [
...
const SCHED_HOURS = ["08:00", "09:00", "10:00", "11:00", "14:00", "15:00", "16:00", "17:00"];
/* cat: 體操(blue) / 啦啦隊(gold) / 跑酷(green) */
const SCHED_COURSES = [
...
const ATT_CLASS = { name: "兒童體操初階班", time: "今日 16:00–17:30", room: "A 教室", coach: "陳怡君" };
const ATT_ROSTER = [
...
const SHARED_FILES = [
  { name: "小明_平衡木練習.mp4", meta: "影片 · 12.4 MB", icon: "play-circle", tint: "var(--df-primary)" },
  { name: "比賽報名表.jpg", meta: "圖片 · 2.1 MB", icon: "image", tint: "var(--df-success)" },
];

Object.assign(window, {
  Ic, useLucide, COACH, TODAY_LABEL,
  TODAY_CLASSES, CLASS_STATUS, LEVEL_TINT, STUDENTS,
  SCHED_DAYS, SCHED_HOURS, SCHED_COURSES, CAT_COLOR,
  ATT_CLASS, ATT_ROSTER, CONVERSATIONS, THREAD, SHARED_FILES,
});
